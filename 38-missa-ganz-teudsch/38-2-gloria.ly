    ...
    \new ChoirStaff = "Vocalis 1" <<
      \new Staff <<
        \new Voice = "cantus 1" <<
          ...
          \cantusONEnotes
        >>
        \new Lyrics \lyricsto "cantus 1" \cantusONEwords
      >>
      \new Staff <<
        \new Voice = "tenor 1" <<
          \global
          \tenorONEnotes
        >>
  %       \new Lyrics \lyricsto "tenor 1" \tenorONEwords
      >>
      \new Staff <<
        \new Voice = "alto 1" <<
          \global
          \altoONEnotes
        >>
  %       \new Lyrics \lyricsto "alto 1" \altoONEwords
      >>
      \new Staff <<
        \new Voice = "bass 1" <<
          \global
          \bassONEnotes
        >>
  %       \new Lyrics \lyricsto "bass 1" \bassONEwords
      >>
    >>
    ...
    \new ChoirStaff = "Vocalis 2" <<
      \new Staff <<
        \new Voice = "cantus 2" <<
          ...
          \cantusTWOnotes
        >>
  %       \new Lyrics \lyricsto "cantus 2" \cantusTWOwords
      >>
      \new Staff <<
        \new Voice = "alto 2" <<
          \global
          \altoTWOnotes
        >>
  %       \new Lyrics \lyricsto "alto 2" \altoTWOwords
      >>
      \new Staff <<
        \new Voice = "tenor 2" <<
          \global
          \tenorTWOnotes
        >>
  %       \new Lyrics \lyricsto "tenor 2" \tenorTWOwords
      >>
      \new Staff <<
        \new Voice = "bass 2" <<
          \global
          \bassTWOnotes
        >>
  %       \new Lyrics \lyricsto "bass 2" \bassTWOwords
      >>
    >>
    ...
    \new ChoirStaff = "Instrumentalis" <<
      \new Staff <<
        \new Voice = "cantus inst 1" <<
          ...
          \cantusONEINSTnotes
        >>
  %        \new Lyrics \lyricsto "cantus inst 1" \cantusONEINSTwords
      >>
       \new Staff <<
        \new Voice = "cantus inst 2" <<
          ...
          \cantusTWOINSTnotes
        >>
        % \new Lyrics \lyricsto "cantus inst 2" \cantusTWONSTwords
      >>
      \new Staff <<
        \new Voice = "bass inst" <<
          \global
          \bassINSTnotes
        >>
  %       % \new Lyrics \lyricsto "bass inst" \bassINSTwords
      >>
    >>
