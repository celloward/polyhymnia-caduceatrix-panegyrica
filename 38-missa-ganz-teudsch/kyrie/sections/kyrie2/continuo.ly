...
\new Staff = "Continuo" {
  ...
  c2 d g,1 r2^\markup { "Cantus 1 and 2" } c4\f c \i d e f g \l c2 r4 c8\p c d4 e f g \l c c8\p^\markup { "Insturments" } c f4 a \i f2 g c c4\f^\markup { "Cantus 1 and 2" } a, \l b, c d e a,2 r4 a,4\p \l
  % pg 3
  b,4 c d e a, a,8\p^\markup { "Instr" } a, d4 f \l d e a,2 r\^\markup { "Cantus 1 and 2" } g,4\f g, \l c2 g d d \l g, g,4\p g, c2 g \l d d g,1 \l
