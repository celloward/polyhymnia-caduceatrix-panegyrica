  ...
  \include "../form.ly"
    {
      ...
      e4.) d8 c2 d g,1 r1 r2 r4 g4\p c8( d e c) d( c d4) g,1 r1 r r4 g4\p c2 d g, r1 r r2 d2\f g4 e a a, d1 d r1 r
      r2 g4(\f f e d) c2 d\breve g,1 r2 d4 b, a,2 e, a,1 d2 d4 g, a,2 d g,1 c4 b, d2 g, g,4 g, a,2 d g,1 c2 b, d1( d,) g,1 r1 r
      r2 b,4\p( c d2) g, r1 r1 r2 b,4(\p c d2) g, r1 r r2 c4(\p d e2) a, r1 r r2 c4( d e2) a, r1 r r r2 e4(\p f g2) c r1 f4( g a2) d r2 r1
      r1 r r2 g,2\f( d\breve) g,1 r1 d\breve g,1 r1 c\breve. c\breve g,\breve. g,\longa~ g,\fermata \bar "|."
    }
  >>
