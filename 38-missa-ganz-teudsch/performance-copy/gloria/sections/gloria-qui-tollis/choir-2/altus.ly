...
\new Staff <<
  \new Voice = "alto 2" <<
    ...
    \include "../form.ly"
    {
      ...
      r1 r2 r4 d'4\p e'8( f' g' e') fis'( g' e' fis') g'1 r1 r r4 g'4\p a'8( g' g'2) fis'4 g'2 r1 r r2 fis'2\f g'4 g' a' e' fis'1 fis'
      r1 r r2 g'1\f e'2 d'\breve b1 r2 d'4 d' e'2 e' e'1 fis'2 fis'4 g' e'2 fis' g' d' e'4 d' d'2 b g'4 g' e'2 fis'
      g' d' c' d'2.( e'4 fis' g' a'2 d') d'1 r1 r r2 g'4.(\p e'8 a'4 d') d'2 r1 r r2 g'4.(\p e'8 a'4 d') d'2 r1 r r2 c'4(\p a e'2) e' r1
      r1 r2 c'4(\p a e'2) e' r1 r r r4 g'2(\p f'8 e' d'2) e' r1 a'4( g'8 f' e'2) d' r2 r1 r r r2 d'1\f d'2 d'1 d' r1 d'4( e' fis' g' a' g' fis'2) g'1 r1
      e'4( f' g' f' e' f' g' f' e' f' g' f' e' d' e' f' g'1~ g'\breve.) g'\longa~ g'\fermata \bar "|."
    }
  >>
