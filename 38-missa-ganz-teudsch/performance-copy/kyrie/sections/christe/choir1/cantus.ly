...
\new Staff <<
  ...
  \new Voice = "Cantus 1" <<
    \include "../../../settings/choir1/cantus.ly"
    {
      ...
      b'8( c''16 b' c'' b' a' b') c''2 r4 g'\f e'8( f' g' e') fis'( g' a' fis') g'( a' b') g' \l a'4 b' c'' d''\p g'8( a' b' g') a'4 b'(
      c''2) r4 b'4\f b'( cis'' d'') d'' g'8( f' g' a' g' a' b' c'') a'( b' c'' b' a' g' a'4) b'2 g'8\p( a' b' c'')
